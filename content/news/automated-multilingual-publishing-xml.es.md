...
3. **La traducción se enchufa limpiamente.** La capa de texto se exporta como XLIFF/XML a los traductores y se reimporta — la misma [cadena de traducción XML](/es/news/pdf-translation-workflow-editable/) usada para software y contenido web — con marcadores de posición y estructura protegidos por el formato en lugar de por la disciplina del traductor.
