...
3. **La longitud de línea y la velocidad de lectura sobreviven mal a la traducción.** El alemán es ~30 % más largo que el inglés; un cue de dos líneas en inglés puede convertirse en cuatro líneas en alemán que ningún espectador puede leer en el tiempo en pantalla. La planificación de la [expansión del texto](/es/news/text-expansion-translation-layout/) ocurre en la traducción, pero la verificación de *formato* es la pasada de QA de subtítulos: caracteres por línea, líneas por cue, duración mínima en pantalla.
...
- **Mantenga cortos los conteos de líneas CJK**: el chino/japonés/coreano transmiten más por carácter, así que los cues traducidos a menudo se acortan — una oportunidad de aumentar la comodidad de lectura, según las [notas de subtitulado CJK](/es/news/subtitle-formatting-rules/).
