...
1. **Expansión (y contracción) del texto.** El alemán y el ruso se expanden un 20–35 % sobre el inglés; el chino se contrae pero necesita tamaños de punto mayores para ser legible. Cada cuadro de texto, celda de tabla y forma de tamaño fijo es una mina de maquetación — el [problema de la expansión de texto](/es/news/text-expansion-translation-layout/) en su forma más pura.
...
4. **Dirección y alineación para RTL.** Las presentaciones en árabe/hebreo necesitan diseños espejados: texto alineado a la derecha, viñetas y flechas invertidas, gráficos que se leen de derecha a izquierda. Una traducción volcada en el diseño LTR se lee como un espejo roto — las [reglas de DTP en árabe](/es/news/arabic-dtp-indesign-rtl/) se aplican a las diapositivas igual que a los folletos.
