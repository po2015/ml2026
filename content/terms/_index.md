...
description: "MediaLocalize Terms of Service — the agreement governing use of our website and services."
section_label: "Legal"
...
1. A quotation issued by MediaLocalize is valid for **30 calendar days** from the date of issue unless otherwise stated.
2. An order is accepted only upon our written confirmation and receipt of the required deposit.
3. We reserve the right to decline any order without stating a reason.
4. Project scope changes requested after acceptance may result in revised pricing and timelines, documented in a change order.
